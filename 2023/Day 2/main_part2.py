...
for line in lines: 
    ...
    minimum_cubes_req = {"red":0,"green":0,"blue":0}
    ...
    for reveal in game_all_reveals:
        ...
        for entry in arr_colour_and_count:
            ...
            minimum_cubes_req[colour] = max(minimum_cubes_req[colour],num_of_colour)

    running_sum = running_sum + (minimum_cubes_req["red"] * minimum_cubes_req["green"] * minimum_cubes_req["blue"])
